export const questionsByCategory = {
  Engine: [
    {
      ...
      options: ["To increase engine power", "To cool the engine", "To filter the oil", "To reduce noise"],
      correctAnswer: 1,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      options: ["Rotations Per Mile", "Revolutions Per Minute", "Rear Power Module", "Rapid Performance Motor"],
      correctAnswer: 1,
    },
    {
      id: 4,
    ...
    },
    {
      ...
      options: ["Diesel engine", "Rotary engine", "Magnetic engine", "Electric engine"],
      correctAnswer: 2,
    },
  ],
  Electrical: [
  ...
  "Traffic Rules": [
    {
      ...
      options: ["Passing is permitted", "No passing zone", "Pedestrian crossing ahead", "Construction zone"],
      correctAnswer: 1,
    },
    {
      id: 2,
  ...
  "Road Signs": [
    ...
    },
    {
      ...
      options: ["Stop ahead", "Warning or hazard ahead", "Speed limit", "Construction zone"],
      correctAnswer: 1,
    },
    {
      id: 3,
    ...
    },
    {
      ...
      options: ["Danger ahead", "No entry or prohibited action", "Railroad crossing", "Construction zone"],
      correctAnswer: 1,
    },
    {
      id: 5,
      text: "What does a pentagonal sign indicate?",
      options: ["School zone", "Hospital nearby", "Wildlife crossing", "Recreational area"],
      correctAnswer: 0,
    },
  ],
  "Safety Procedures": [
    {
      ...
      options: ["Radio settings", "Seat position and mirrors", "Fuel level", "Tire pressure"],
      correctAnswer: 1,
    },
    {
      id: 2,
